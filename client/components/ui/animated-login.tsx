...
// 1. Login-specific validation schema
...
export default function LoginPage() {
  ...
  // 2. Setup react-hook-form using login credentials
  const {
    register,
    handleSubmit,
    watch,
  ...
  // Watch the password string length for character visual reactions
  ...
  // 3. Update connection endpoint configuration details
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left Illustrative Content Section */}
            ...
            >
              ...
              >
                <Pupil
                  ...
                  pupilColor="#2D2D2D"
                  forceLookX={
                    passwordValue.length > 0 && showPassword ? -5 : undefined
                  }
                  forceLookY={
                    passwordValue.length > 0 && showPassword ? -4 : undefined
                  }
                />
                <Pupil
                  size={12}
      ...
      {/* Right Login Layout Form Section */}
